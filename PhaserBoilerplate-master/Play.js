...
boil.Play.prototype = {
    ...
    create: function() {
        ...
        Floor = map.createLayer('tile');
        Design = map.createLayer('green');
        DesignGreen = map.createLayer('purple');
        collusion = map.createLayer('collusionn');
     
        //96-105
        
        map.setCollisionBetween(3, 10, true, 'collusionn');
...
//                var tree = game.add.sprite(0, 0, 'trees');
	...
	this.buttonMenu4 = this.add.button(1536, 1536,  'exit', function () {
	   ...
	   optionmenu.fixedToCamera = true;
        ...
        brick = game.add.sprite(807, 430, 'brick');
        game.physics.arcade.enable(brick);
        brick.body.immovable = true;
        brick.scale.setTo(0.19, 0.19);
        ...
        gate3.animations.add('open', [1,0],3);
...
//            
            ...
            this.storyText[3]="Player: Do you know how I can get in that tower?";
            this.storyText[4]="Girl: Why? You'd be better off leaving...";
            this.storyText[5]="Girl: without speaking a word of that tower again!";
...
//
    ...
    update: function() {
        ...
        game.physics.arcade.overlap(player, brick, function(){console.log('hitting1')});
        game.physics.arcade.collide(player, brick);
...
//            
//        }
        else if (checkOverlap(player, gate)) {
                  try {
                console.log("yasss");
                textJ.text = moreText[position++];
                textbox.visible = true;
